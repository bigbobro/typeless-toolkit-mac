...
function writeVersionState(version) {
  ...
  fs.mkdirSync(ROOT, { recursive: true });
  fs.writeFileSync(VERSION_STATE_FILE, JSON.stringify(data, null, 2));
  return data;
}
...
module.exports = {
  ...
  API_BASE, CDP_PORT, MASTER_CSV, PROFILES_DIR, ACCOUNTS_FILE, RUNTIME_BACKUPS_DIR, VERSION_STATE_FILE, SNAPSHOT_FILES,
  // 工具
